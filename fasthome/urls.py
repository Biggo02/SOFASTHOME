...
urlpatterns = [
    path('admin/', admin.site.urls), path('', views.home, name='home'), path('rechercher/', views.search, name='search'),
    path('bien/<int:pk>/', views.property_detail, name='property_detail'), path('bien/<int:pk>/visite/', views.request_visit, name='request_visit'),
    path('bien/<int:pk>/favori/', views.toggle_favorite, name='toggle_favorite'), path('inscription/', views.register, name='register'),
    path('connexion/', views.login_view, name='login'), path('deconnexion/', views.logout_view, name='logout'),
    ...
    path('mes-contrats/', views.contracts, name='contracts'), path('mes-paiements/', views.payments, name='payments'), path('mes-echeances/', views.due_dates, name='due_dates'),
    path('notifications/', views.notifications, name='notifications'), path('messages/', views.messages_page, name='messages'),
    ...
    path('gestion/publication/<int:pk>/', views.review_publication, name='review_publication'), path('gestion/visite/<int:pk>/', views.manage_visit, name='manage_visit'), path('404/', views.error_404, name='error_404'),
]
