...
class Property(models.Model):
    ...
    FENCE_TYPES=[('mur','Mur'),('grillage','Grillage'),('metal','Métallique'),('beton','Béton'),('bois','Bois'),('mixte','Mixte'),('other','Autre')]
    ...
    fence=models.BooleanField(default=False); fence_type=models.CharField(max_length=30,choices=FENCE_TYPES,blank=True); fence_condition=models.CharField(max_length=30,blank=True)
