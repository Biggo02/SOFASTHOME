...
class Property(models.Model):
    ...
    province=models.CharField(max_length=100,default='Haut-Katanga'); city=models.CharField(max_length=100,default='Lubumbashi'); commune=models.CharField(max_length=100,blank=True); neighborhood=models.CharField(max_length=120,blank=True); full_address=models.CharField(max_length=255,blank=True)
    ...
    rent=models.DecimalField(max_digits=10,decimal_places=2,default=0); deposit=models.DecimalField(max_digits=10,decimal_places=2,default=0); margin=models.DecimalField(max_digits=10,decimal_places=2,default=0); availability_date=models.DateField(null=True,blank=True); available_now=models.BooleanField(default=True); latitude=models.DecimalField(max_digits=9,decimal_places=6,null=True,blank=True); longitude=models.DecimalField(max_digits=9,decimal_places=6,null=True,blank=True); rejection_reason=models.TextField(blank=True); status=models.CharField(max_length=20,choices=STATUSES,default='draft'); views=models.PositiveIntegerField(default=0); created_at=models.DateTimeField(auto_now_add=True); updated_at=models.DateTimeField(auto_now=True)
